...
@section('content')
    ...
    <section class="pt-page" data-id="home">
        <div class="edit">
            <a href="{{ route('admin.edit',1)}}" style="
        right: -75px;
        color:white;
        position: absolute;
        top: 40px;
        font-size: 18px;" class="btn btn-info"><i class="fa fa-edit"></i>Edit</a>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <ul class="info-list">
                            ...
                            <li><span class="title">{{__('message.mail')}}</span><span class="value email"><a href="mailto:hazemlababidi96@gmail.com"></a>{{$user->email}}</span></li>
                            ...
                            <li>
                                ...
                                <span class="block">
                                    @if (session('code'))
                                    <p style="color: red">{{ session('code') }}</p>
                                    {{-- <div class="col-sm-12">
    ...
    <section class="pt-page" data-id="resume">
        <div class="edit">
            <a href="{{route('admin.resume')}}" style="
            right: -95px;
            color:white;
            position: absolute;
            top: 112px;
            font-size: 18px;" class="btn btn-info"><i class="fa fa-eye"></i> Show</a>

            <a href="{{route('admin.resume.add')}}" style="
            right: -75px;
            color:white;
            position: absolute;
            top: 40px;
            font-size: 18px;color:#FFF;
            background: rgb(0, 188, 212);" class="btn btn-success"><i class="fa fa-plus"></i> Add</a>
        </div>
    ...
    <section class="pt-page" data-id="services">
        <div class="edit">
            ...
            <a href="{{route('admin.services.add')}}" style="
            right: -75px;
            color:white;
            position: absolute;
            top: 40px;
    ...
    <section class="pt-page" data-id="portfolio">
        <div class="edit">
            <a href="{{route('admin.portfolio')}}" style="
            right: -95px;
            color:white;
            position: absolute;
            top: 112px;
            ...
            <a href="{{route('admin.portfolio.add')}}" style="
            right: -75px;
            color:white;
            position: absolute;
            top: 40px;
...
{{--                        <form id="contact-form" method="post" action="http://lmpixels.com/demo/procard/contact_form/contact_form.php">--}}
...
{{--                        </form>--}}
                        ...
                        <form action="{{route('admin.home.UpdateQr', $user->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="file" class="form-control mb-2" name="Qr">
